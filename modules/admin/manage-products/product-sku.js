...
function renderProducts(list) {
    ...
    tbody.innerHTML = list.map(item => {
        ...
        const skuName = item.skuName || item.name || 'N/A';
        ...
        <tr>
            <td>
                <img src="${imageUrl}" alt="${skuName}" class="product-image" style="width: 50px; height: 50px; object-fit: cover;">
            </td>
            <td>
                <div class="fw-bold">${skuName}</div>
